...
The compiler creates an eager object when it finds a \textbf{formation} in the source code.
It is an associative array of attributes vs immutable object references.
...
An \textbf{application} is a trio of an object reference (called ``prototype''), an attribute, and an immutable object reference (called ``argument'').
A \textbf{dispatch} is a trio of an object reference (called ``base''), an attribute, and a mutable---initially blank---object reference.
