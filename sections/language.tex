...
\begin{enumerate}
  \item \ff{dispatch(base, attr)} -- creates a new dispath object;
  \item \ff{application(prototype, attr, argument)} -- creates a new application object;
  \item \ff{formation(attr\(_0\), attr\(_1\), ...)} -- creates a new formation object;
  \item \ff{delta(object, data)} -- sets \(\Delta\)-asset to the object;
  \item \ff{lamda(object, name)} -- sets \(\lambda\)-asset to the object;
  \item \ff{put(base, attr, kid)} -- sets attribute of the object.
\end{enumerate}
