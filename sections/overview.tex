...
A \emph{formation} is a collection of \emph{attributes}, which are uniquely named pairs, for example:
\begin{phiquation}
...
A formation is called a \emph{decorator} if it has the $@$-attribute with a formation attached to it,
