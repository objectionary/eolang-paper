...
\iexec[maybe]{phino dataize --output=latex --sweet --nonumber --compress --canonize --meet-prefix=dataization --sequence --flat --quiet --hide=Q.org --locator=Q.ex ./examples/celsius.phi > _tex/celsius-dataization.tex}
\begin{landscape}
