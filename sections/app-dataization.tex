...
\iexec[maybe]{phino dataize --output=latex --sweet --nonumber --compress --canonize --meet-prefix=dataization --sequence --flat --quiet --hide=Q.bytes --hide=Q.number --locator=Q.ex ./examples/celsius.phi > _tex/celsius-dataization.tex}
% \begin{landscape}
\scalebox{.3}{\parbox{\linewidth}{\input{_tex/celsius-dataization.tex}}}
% \end{landscape}
