...
\begin{phiquation*}
|F1| : \langle b{,}\; u{,}\; s \rangle \to \langle u.number( D> \mathbb{D} {(} b.^ {,}\; u {)} \times \mathbb{D} {(} b.|x| {,}\; u {)} ) {,}\; s \rangle
|F2| : \langle b{,}\; u{,}\; s \rangle \to \langle u.number( D> \mathbb{D} {(} b.^ {,}\; u {)} + \mathbb{D} {(} b.|x| {,}\; u {)} ) {,}\; s \rangle
\end{phiquation*}
