...
\begin{phiquation*}
|F1|(b,s) \to \langle QQ.number( D> \mathbb{D}(b.^) \boldsymbol{\times} \mathbb{D}(b.\alpha_0) ), s \rangle
|F2|(b,s) \to \langle QQ.number( D> \mathbb{D}(b.^) \boldsymbol{+} \mathbb{D}(b.\alpha_0) ), s \rangle
\end{phiquation*}
