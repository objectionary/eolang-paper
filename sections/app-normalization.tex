...
\iexec[maybe]{./examples-to-tex.sh examples/basic > examples.tex}
\input{examples.tex}
...
\iexec[maybe]{./examples-to-tex.sh examples/nf > examples-nf.tex}
\input{examples-nf.tex}
...
\begin{phiquation*}
\phiExpression{e1} [[ |x| -> [[ ]].\rho.|y|, |y| -> \xi.|x| ]].|x| \trans \dots

\phiExpression{e2} [[ |x| -> \xi.|y|, |y| -> \xi.|x| ]].|x| \trans \dots

\phiExpression{e3} [[ |x| -> [[ |k| -> ? ]] ( |k| -> \xi.|y| ), |y| -> 42 ]] \trans \dots
\end{phiquation*}
