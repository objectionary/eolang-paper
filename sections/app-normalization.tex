...
% \begin{phiquation*}
% \phiExpression{apk} \phiMeet{u:apk:1}{ [[ |x| -> [[ |x| -> ? ]] ( |x| -> \xi.|t| ), |t| -> 42 ]] } \trans_{\nameref{r:copy}}
%   \trans [[ |x| -> [[ |x| -> 42 ]], |t| -> 42 ]].
...
% \begin{phiquation*}
% \phiExpression{fnk} \phiMeet{u:11}{ [[ |x| -> [[ |t| -> ? ]] ( |t| -> \xi.|k| ), |k| -> [[ L> Fn(\xi.\rho) ]] ]] }.|x|.|t|.|p| \trans_{\nameref{r:dot}}
...
%     \trans \phiMeet{u:12}{ [[ |t| -> \cref{u:11}.|k|, \rho -> \cref{u:11} ]] } . |t|.|p| \trans_{\nameref{r:dot}}
