...
\ff{.} for the dot notation, and \ff{[]} for the specification of parameters of formations.
...
Identifiers are case-sentitive: \ff{acar} and \ff{aCar} are two different identifiers.
Java-notation is used for numbers and strings.

\subsection{Objects}

This is a formation of a new object \ff{book}
with has a single \ff{isbn} attribute:
...
\ff{number} & \ff{1024}, \ff{0x1A7E}, or \ff{-42} & 8 \\
\ff{true} & \ff{true} & 1 \\
\ff{false} & \ff{false} & 1 \\
\bottomrule
\end{tabularx}
