...
\sugar
  ...
  { Q  . |org| . |eolang|}
\sugar
  {e ( \tau_1 \tto e_1 ,\; \tau_2 \tto e_2 ,\; \dots )}
  {e ( \tau_1 \tto e_1 )( \tau_2 \tto e_2 ) \dots}
\sugar
  {e ( e_0 ,\; e_1 , \dots )}
  {e ( \alpha_0 \tto e_0 ,\; \alpha_1 \tto e_1 ,\; \dots )}
\sugar
  {\tau_1 ( \tau_2 ,\; \tau_3 ,\; \dots ) \tto [[ B ]]}
  {\tau_1 \tto [[ \tau_2 \tto ? ,\; \tau_3 \tto ? ,\; \dots ,\; B ]]}
\sugar
  {\tau_1 \tto \tau_2}
  {\tau_1 \tto \xi.\tau_2}
\sugar
  {[[ B ]]}
  {[[ B ,\; \rho \tto ? ]] \quad\text{if}\; \rho \notin B}
\sugar
  {\texttt{\begin{CJK}{UTF8}{gbsn}"你好"\end{CJK}}}
  { QQ  . |string| (  QQ  . |bytes| ( [[  D> \; |E4-BD-A0-E5-A5-BD| ]] ) )}
  \subs{UTF-8 string}
\sugar
  {42}
  { QQ  . |number| (  QQ  . |bytes| ( [[  D> \; |40-45-00-00-00-00-00-00| ]] ) )}
  \subs{eight bytes per integer}
\sugar
  {3.14}
  { QQ  . |number| (  QQ  . |bytes| ( [[  D> \; |40-09-1E-B8-51-EB-85-1F| ]] ) )}
