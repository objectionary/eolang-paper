...
The \emph{morphing} function \(\mathbb{M} : \mathcal{E} \times \mathcal{B} \times \mathcal{S} \to \mathcal{P} \times \mathcal{S} \)
...
\(\mathbb{D} : \mathcal{E} \times \mathcal{B} \times \mathcal{S} \to \mathcal{D} \times \mathcal{S}\)
