...
{ \langle \stx{ [[ } B_1 , \stx{ L> } f , B_2 \stx{ ]] } \bullet{} t, u, s_1 \rangle \stepto \langle p, s_3 \rangle }  \
\;\text{if}\; f( \stx{ [[ } B_1, B_2 \stx{ ]] }, u, s_1 ) \to \langle e, s_2 \rangle

\newrule[\Phi]{Mphi} \
\frac \
{ \langle e \bullet{} t, u, s_1 \rangle \stepto \langle p, s_2 \rangle} \
{ \langle \stx{ \Phi } \stx{ . } \tau \bullet{} t, u, s_1 \rangle \stepto \langle p, s_2 \rangle }  \
\;\text{if}\; u = \stx{ \llbracket } B_1 , \tau \stx{ \mapsto } e, B_2 \rrbracket
\end{phiquation*}
\end{mdframed}
\capt{Morphing rules.}
\label{fig:morphing}
...
\frac \
{ } \
{ \langle \stx{ [[ } B_1, \stx{ D> } \delta, B_2 \stx{ ]] }, u, s \rangle \stepto \langle \delta, s \rangle } \
\quad\quad \
\newrule{norm} \
...
{ \langle \stx{ [[ } B_1, \stx{ @ } \stx{ -> } e, B_2 \stx{ ]] }, u, s_1 \rangle  \stepto \langle \delta, s_2 \rangle } \
