...
\quad \
\newrule{norm} \
\frac{ \langle p {,}\; u {,}\; s_2 \rangle \stepto \langle \delta {,}\; s_3 \rangle }{ \langle e {,}\; u {,}\; s_1 \rangle  \stepto \langle \delta {,}\; s_2 \rangle } \
\;\text{if}\; \mathbb{M} {(} e {,}\; u {,}\; s_1 {)} \to \langle p {,}\; s_3 \rangle
