...
The two indented lines under the head expression on the line above
  form a single \ff{BYTES} literal \ff{CA-FE-BE-BE}, occupying one
  argument slot of that head.
