...
\newcommand\uplace[2]{%
  \def\param{#1}%
  \ifx\param\empty\else\ifmeasuring@\else\refstepcounter{uplace}\cref@label{#1}\fi\fi%
...
\newcommand\phiMeet[2]{%
  ...
  \def\param{#1}%
  {\color{gray}\overbracket[0.4pt][1pt]{{\color{black}#2}}^{{\ifx\param\empty\else\color{gray}\mathrm{H}_{\thephimeet}\fi}}}}
\makeatother
\crefformat{phimeet}{{\color{gray}\mathrm{H}_{#2#1#3}}}
